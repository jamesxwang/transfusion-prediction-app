    ...
    <div class="form_container">
      <div class="step step_one" v-if="active===0">
        ...
        <el-row>
          ...
          <el-col :xs="12" :sm="8" :md="12" :lg="8" :xl="8"><el-input v-model.number="form['Age']" placeholder="Age"></el-input></el-col>
        </el-row>
        <el-row>
      ...
      <div class="step step_three" v-if="active>=2">
        ...
        <el-row>
          ...
          <el-col :xs="12" :sm="8" :md="12" :lg="8" :xl="8"><el-input type="number" v-model.number="form['INR International Normalized Ratio(INR)']" placeholder="International Normalized Ratio(INR)"></el-input></el-col>
        </el-row>
        <el-row>
